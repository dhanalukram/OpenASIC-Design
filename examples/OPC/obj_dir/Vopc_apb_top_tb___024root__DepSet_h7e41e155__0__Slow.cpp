...
VL_ATTR_COLD void Vopc_apb_top_tb___024root___eval_initial__TOP(Vopc_apb_top_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vopc_apb_top_tb___024root___eval_initial__TOP\n"); );
    Vopc_apb_top_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    VlWide<4>/*127:0*/ __Vtemp_1;
    // Body
    vlSelfRef.opc_apb_top_tb__DOT__PCLK = 0U;
    vlSelfRef.opc_apb_top_tb__DOT__pass_count = 0U;
    vlSelfRef.opc_apb_top_tb__DOT__fail_count = 0U;
    __Vtemp_1[0U] = 0x2e766364U;
    __Vtemp_1[1U] = 0x5f746f70U;
    __Vtemp_1[2U] = 0x5f617062U;
    __Vtemp_1[3U] = 0x6f7063U;
...
VL_ATTR_COLD void Vopc_apb_top_tb___024root___eval_triggers__stl(Vopc_apb_top_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vopc_apb_top_tb___024root___eval_triggers__stl\n"); );
    Vopc_apb_top_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
