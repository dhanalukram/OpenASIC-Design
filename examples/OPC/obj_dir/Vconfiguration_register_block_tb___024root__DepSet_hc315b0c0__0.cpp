...
VL_INLINE_OPT VlCoroutine Vconfiguration_register_block_tb___024root___eval_initial__TOP__Vtiming__1(Vconfiguration_register_block_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vconfiguration_register_block_tb___024root___eval_initial__TOP__Vtiming__1\n"); );
    ...
    while (VL_LIKELY(!vlSymsp->_vm_contextp__->gotFinish())) {
        ...
        vlSelfRef.configuration_register_block_tb__DOT__clk 
            = (1U & (~ (IData)(vlSelfRef.configuration_register_block_tb__DOT__clk)));
    }
}
...
void Vconfiguration_register_block_tb___024root___eval_triggers__act(Vconfiguration_register_block_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vconfiguration_register_block_tb___024root___eval_triggers__act\n"); );
    Vconfiguration_register_block_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VactTriggered.setBit(0U, ((IData)(vlSelfRef.configuration_register_block_tb__DOT__clk) 
                                          & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__configuration_register_block_tb__DOT__clk__0))));
    vlSelfRef.__VactTriggered.setBit(1U, ((~ (IData)(vlSelfRef.configuration_register_block_tb__DOT__rst_n)) 
                                          & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__configuration_register_block_tb__DOT__rst_n__0)));
