...
VL_ATTR_COLD void Vapb_wrapper_tb___024root__trace_init_sub__TOP__0(Vapb_wrapper_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+17,0,"PCLK",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+12,0,"PSLVERR",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+13,0,"write_en_o",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+14,0,"read_en_o",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+15,0,"addr_o",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+16,0,"wdata_o",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBit(c+12,0,"PSLVERR",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+13,0,"write_en_o",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+14,0,"read_en_o",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+15,0,"addr_o",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+16,0,"wdata_o",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBit(c+18,0,"apb_access_w",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+19,0,"apb_write_access_w",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+20,0,"apb_read_access_w",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->popPrefix();
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vapb_wrapper_tb___024root__trace_init_sub__TOP____024unit__0(Vapb_wrapper_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+21,0,"APB_ADDR_WIDTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+23,0,"REG_ADDR_LSB",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
...
VL_ATTR_COLD void Vapb_wrapper_tb___024root__trace_full_0_sub_0(Vapb_wrapper_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+10,(vlSelfRef.apb_wrapper_tb__DOT__PRDATA),32);
    bufp->fullBit(oldp+11,(vlSelfRef.apb_wrapper_tb__DOT__PREADY));
    bufp->fullBit(oldp+12,(vlSelfRef.apb_wrapper_tb__DOT__PSLVERR));
    bufp->fullBit(oldp+13,(vlSelfRef.apb_wrapper_tb__DOT__write_en_o));
    bufp->fullBit(oldp+14,(vlSelfRef.apb_wrapper_tb__DOT__read_en_o));
    bufp->fullCData(oldp+15,(vlSelfRef.apb_wrapper_tb__DOT__addr_o),8);
    bufp->fullIData(oldp+16,(vlSelfRef.apb_wrapper_tb__DOT__wdata_o),32);
    bufp->fullBit(oldp+17,(vlSelfRef.apb_wrapper_tb__DOT__PCLK));
    bufp->fullBit(oldp+18,(vlSelfRef.apb_wrapper_tb__DOT__dut__DOT__apb_access_w));
    bufp->fullBit(oldp+19,(vlSelfRef.apb_wrapper_tb__DOT__dut__DOT__apb_write_access_w));
    bufp->fullBit(oldp+20,(vlSelfRef.apb_wrapper_tb__DOT__dut__DOT__apb_read_access_w));
}
