...
#ifndef VERILATED_VAPB_WRAPPER___024ROOT_H_
#define VERILATED_VAPB_WRAPPER___024ROOT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vapb_wrapper___024root final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vapb_wrapper___024root(Vapb_wrapper__Syms* symsp, const char* v__name);
    ~Vapb_wrapper___024root();
    VL_UNCOPYABLE(Vapb_wrapper___024root);
