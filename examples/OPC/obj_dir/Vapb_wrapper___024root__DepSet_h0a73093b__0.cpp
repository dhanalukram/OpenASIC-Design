...
VL_INLINE_OPT VlCoroutine Vapb_wrapper___024root___eval_initial__TOP__Vtiming__1(Vapb_wrapper___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vapb_wrapper___024root___eval_initial__TOP__Vtiming__1\n"); );
    ...
    apb_wrapper_tb__DOT__pass_count = 0;
    IData/*31:0*/ apb_wrapper_tb__DOT__fail_count;
    apb_wrapper_tb__DOT__fail_count = 0;
    ...
    VL_PRINTF_MT("-Info: tb/apb_wrapper_tb.v:201: $dumpvar ignored, as Verilated without --trace\n");
    __Vtask_apb_wrapper_tb__DOT__reset_dut__0__apb_wrapper_tb__DOT__unnamedblk1_1__DOT____Vrepeat0 = 0;
    __Vtask_apb_wrapper_tb__DOT__reset_dut__0__apb_wrapper_tb__DOT__unnamedblk1_2__DOT____Vrepeat1 = 0;
    ...
    apb_wrapper_tb__DOT__pass_count = 0U;
    apb_wrapper_tb__DOT__fail_count = 0U;
    VL_WRITEF_NX("------------------------------------------------\nAPB WRITE TEST\n------------------------------------------------\n",0);
    co_await vlSelfRef.__VtrigSched_h77c768b5__0.trigger(0U, 
                                                         nullptr, 
                                                         "@(posedge apb_wrapper_tb.PCLK)", 
    ...
    if (vlSelfRef.apb_wrapper_tb__DOT__write_en_o) {
        ...
        apb_wrapper_tb__DOT__pass_count = ((IData)(1U) 
                                           + apb_wrapper_tb__DOT__pass_count);
    } else {
        VL_WRITEF_NX("FAIL : Write Enable NOT Generated\n",0);
        apb_wrapper_tb__DOT__fail_count = ((IData)(1U) 
                                           + apb_wrapper_tb__DOT__fail_count);
    }
    ...
    VL_WRITEF_NX("\n==============================================\n      APB Wrapper Verification Summary\n==============================================\nPassed Checks : %0d\nFailed Checks : %0d\n",0,
                 32,apb_wrapper_tb__DOT__pass_count,
                 32,apb_wrapper_tb__DOT__fail_count);
    if ((0U == apb_wrapper_tb__DOT__fail_count)) {
...
void Vapb_wrapper___024root___eval_triggers__act(Vapb_wrapper___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vapb_wrapper___024root___eval_triggers__act\n"); );
    Vapb_wrapper__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
