...
void Vgpio_controller_tb___024root__trace_chg_0_sub_0(Vgpio_controller_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->chgBit(oldp+0,(vlSelfRef.gpio_controller_tb__DOT__clk));
    bufp->chgBit(oldp+1,(vlSelfRef.gpio_controller_tb__DOT__rst_n));
    bufp->chgCData(oldp+2,(vlSelfRef.gpio_controller_tb__DOT__gpio_data_i),8);
    bufp->chgCData(oldp+3,(vlSelfRef.gpio_controller_tb__DOT__gpio_dir_i),8);
    bufp->chgCData(oldp+4,(vlSelfRef.gpio_controller_tb__DOT__gpio_in_i),8);
    bufp->chgCData(oldp+5,(vlSelfRef.gpio_controller_tb__DOT__gpio_out_o),8);
    bufp->chgCData(oldp+6,(vlSelfRef.gpio_controller_tb__DOT__gpio_input_o),8);
}
