...
void Vapb_wrapper_tb___024root__trace_chg_0_sub_0(Vapb_wrapper_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[3U]))) {
        bufp->chgIData(oldp+9,(vlSelfRef.apb_wrapper_tb__DOT__PRDATA),32);
        bufp->chgBit(oldp+10,(vlSelfRef.apb_wrapper_tb__DOT__PREADY));
        bufp->chgBit(oldp+11,(vlSelfRef.apb_wrapper_tb__DOT__PSLVERR));
        bufp->chgBit(oldp+12,(vlSelfRef.apb_wrapper_tb__DOT__write_en_o));
        bufp->chgBit(oldp+13,(vlSelfRef.apb_wrapper_tb__DOT__read_en_o));
        bufp->chgCData(oldp+14,(vlSelfRef.apb_wrapper_tb__DOT__addr_o),8);
        bufp->chgIData(oldp+15,(vlSelfRef.apb_wrapper_tb__DOT__wdata_o),32);
    }
    bufp->chgBit(oldp+16,(vlSelfRef.apb_wrapper_tb__DOT__PCLK));
    bufp->chgBit(oldp+17,(vlSelfRef.apb_wrapper_tb__DOT__dut__DOT__apb_access_w));
    bufp->chgBit(oldp+18,(vlSelfRef.apb_wrapper_tb__DOT__dut__DOT__apb_write_access_w));
    bufp->chgBit(oldp+19,(vlSelfRef.apb_wrapper_tb__DOT__dut__DOT__apb_read_access_w));
}
