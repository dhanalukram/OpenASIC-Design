...
VL_ATTR_COLD void Vapb_wrapper_tb___024root___eval_static(Vapb_wrapper_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vapb_wrapper_tb___024root___eval_static\n"); );
...
VL_ATTR_COLD void Vapb_wrapper_tb___024root___eval_final(Vapb_wrapper_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vapb_wrapper_tb___024root___eval_final\n"); );
    Vapb_wrapper_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

#ifdef VL_DEBUG
VL_ATTR_COLD void Vapb_wrapper_tb___024root___dump_triggers__stl(Vapb_wrapper_tb___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vapb_wrapper_tb___024root___eval_phase__stl(Vapb_wrapper_tb___024root* vlSelf);

VL_ATTR_COLD void Vapb_wrapper_tb___024root___eval_settle(Vapb_wrapper_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vapb_wrapper_tb___024root___eval_settle\n"); );
    Vapb_wrapper_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
#ifdef VL_DEBUG
            Vapb_wrapper_tb___024root___dump_triggers__stl(vlSelf);
#endif
            VL_FATAL_MT("tb/apb_wrapper_tb.v", 16, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vapb_wrapper_tb___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vapb_wrapper_tb___024root___dump_triggers__stl(Vapb_wrapper_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vapb_wrapper_tb___024root___dump_triggers__stl\n"); );
    Vapb_wrapper_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vapb_wrapper_tb___024root___eval_stl(Vapb_wrapper_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vapb_wrapper_tb___024root___eval_stl\n"); );
    Vapb_wrapper_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
...
VL_ATTR_COLD void Vapb_wrapper_tb___024root___eval_triggers__stl(Vapb_wrapper_tb___024root* vlSelf);

VL_ATTR_COLD bool Vapb_wrapper_tb___024root___eval_phase__stl(Vapb_wrapper_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vapb_wrapper_tb___024root___eval_phase__stl\n"); );
    Vapb_wrapper_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    Vapb_wrapper_tb___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelfRef.__VstlTriggered.any();
    if (__VstlExecute) {
        Vapb_wrapper_tb___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vapb_wrapper_tb___024root___dump_triggers__act(Vapb_wrapper_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vapb_wrapper_tb___024root___dump_triggers__act\n"); );
    Vapb_wrapper_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vapb_wrapper_tb___024root___dump_triggers__nba(Vapb_wrapper_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vapb_wrapper_tb___024root___dump_triggers__nba\n"); );
    Vapb_wrapper_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vapb_wrapper_tb___024root___ctor_var_reset(Vapb_wrapper_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vapb_wrapper_tb___024root___ctor_var_reset\n"); );
    Vapb_wrapper_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->apb_wrapper_tb__DOT__PADDR = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 5628388543141862931ull);
    vlSelf->apb_wrapper_tb__DOT__PWDATA = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 12251801225414799892ull);
    vlSelf->apb_wrapper_tb__DOT__PRDATA = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 12707900062883424492ull);
    vlSelf->apb_wrapper_tb__DOT__PREADY = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 14316180253364843865ull);
    vlSelf->apb_wrapper_tb__DOT__PSLVERR = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1882869200423483221ull);
    ...
    vlSelf->apb_wrapper_tb__DOT__addr_o = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 4101565741346194184ull);
    vlSelf->apb_wrapper_tb__DOT__wdata_o = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 11457624115609404198ull);
    vlSelf->apb_wrapper_tb__DOT__rdata_i = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 12430065149209204622ull);
    vlSelf->apb_wrapper_tb__DOT__pass_count = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 200673140458659978ull);
    vlSelf->apb_wrapper_tb__DOT__fail_count = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 7874679044788519528ull);
